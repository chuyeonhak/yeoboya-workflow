...
- 상태: **SUPERSEDED by `2026-04-21-feature-enrichment-design.md`**

> **폐기 이유 (2026-04-21):** 브레인스토밍 과정에서 사용자 요구를 "이미 구현된 피처 제외" 로 잘못 좁혔다. 실제 요구는 "프로젝트 관점 메타 정보(개발 기간/타부서 의존성/기획 누락/타팀 요청사항)를 각 피처에 덧붙여 재정리" 이다. 새 설계는 위 파일 참조. 본 문서는 논의 히스토리로만 보존.
